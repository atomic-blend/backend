...
func TestDraftMailController_GetDraftMailByID(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			{
				draftMailRoutes.GET("/:id", controller.GetDraftMailByID)
			}

			req, _ := http.NewRequest("GET", "/mail/draft/"+tt.draftMailID, nil)
