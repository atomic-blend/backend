...
type UserEntity struct {
	...
	FailedAt             *primitive.DateTime   `json:"failedAt,omitempty" bson:"failed_at,omitempty"`
	CancelledAt          *primitive.DateTime   `json:"cancelledAt,omitempty" bson:"cancelled_at,omitempty"`
}
