...
import (
	...
	"github.com/atomic-blend/backend/calendar/controllers"
	"github.com/atomic-blend/backend/calendar/controllers/health"
...
func main() {
	...
	amqpService := amqpservice.NewAMQPService("CALENDAR")
