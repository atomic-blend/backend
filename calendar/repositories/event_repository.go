...
type EventRepositoryInterface interface {
	...
	UpdateWithContext(ctx context.Context, id primitive.ObjectID, event *models.Event) (*models.Event, error)
...
func (r *EventRepository) Update(ctx *gin.Context, id primitive.ObjectID, event *models.Event) (*models.Event, error) {
	cctx := ctx.Request.Context()
	return r.UpdateWithContext(cctx, id, event)
}

// UpdateWithContext modifies an existing event by UID using provided context
func (r *EventRepository) UpdateWithContext(ctx context.Context, id primitive.ObjectID, event *models.Event) (*models.Event, error) {
	now := primitive.NewDateTimeFromTime(time.Now())
	event.UpdatedAt = &now
	...
	return r.GetByUIDWithContext(ctx, event.UID)
}
