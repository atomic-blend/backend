...
- exclude rc tags from the get last tag when getting changed files - (6ab67c1) - Brandon Guigo
- simplify the test for no conventional commits detection - (b18840c) - Brandon Guigo

- - -

## grpc/v0.2.0-rc.20 - 2025-09-20
#### Miscellaneous Chores
...
## shared/v0.0.1-rc.2 - 2025-09-20
#### Bug Fixes
- regenerate buf - (c5677e5) - Brandon Guigo
#### Miscellaneous Chores
...
#### Miscellaneous Chores
- **(release)** bump versions for auth@auth-v0.8.1 grpc@grpc-v0.0.1 productivity@productivity-v0.8.1 [skip ci] - (cdbbcde) - GitHub Actions
