...
func (x *GetUserPublicKeyRequest) GetEmail() string {
	if x != nil {
		return x.Email
	}
	return ""
...
func (x *GetUserPublicKeyResponse) GetUserId() string {
	if x != nil {
		return x.UserId
	}
	return ""
...
var file_user_v1_user_service_proto_depIdxs = []int32{
	5, // 0: user.v1.GetUserDevicesRequest.user:type_name -> auth.v1.User
